...
class DefaultColors {
  ...
  static const Color whieteText = Color(0xFFFFFFFF);
  ...
  static const Color menuHeader = Color(0xFF1B202D);
  static const Color menu = Color(0xFF292F3F);
  static const Color chatBackgroud = Color(0xFF1B202D);
  static const Color changeInfo = Color.fromARGB(255, 68, 72, 84);
  static const Color chatAppBar = Color.fromARGB(255, 51, 54, 63);
